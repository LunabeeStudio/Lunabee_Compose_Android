...
// FIXME <waitingSupport> the androidx-paging-compose artifact does not support iOS for now.
//  -> https://github.com/chrisbanes/tivi/blob/main/thirdparty/androidx/paging/compose/src/commonMain/kotlin/LazyPagingItems.kt
//  -> https://github.com/cashapp/multiplatform-paging/issues/245
//  -> This class should be safely removable when support for iOS is added in native library.

/**
 * The class responsible for accessing the data from a [Flow] of [PagingData].
 * In order to obtain an instance of [LazyPagingItems] use the [studio.lunabee.monitoring.ui.collectAsLazyPagingItems] extension
...
/**
 * Collects values from this [Flow] of [PagingData] and represents them inside a [studio.lunabee.monitoring.ui.LazyPagingItems]
 * instance. The [studio.lunabee.monitoring.ui.LazyPagingItems] instance can be used for lazy foundations such as
