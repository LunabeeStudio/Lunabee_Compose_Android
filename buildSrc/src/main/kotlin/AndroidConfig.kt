...
object AndroidConfig {
    ...
    const val LBCCORE_VERSION: String = "1.5.0"
    const val LBCFOUNDATION_VERSION: String = "1.4.0"
    const val LBCANDROIDTEST_VERSION: String = "1.5.0"
    const val LBCACCESSIBILITY_VERSION: String = "1.8.0"
    const val LBCTHEME_VERSION: String = "1.4.0"
    const val MATERIAL_COLOR_UTILITIES_VERSION: String = "1.4.0"
    const val LBCHAPTIC_VERSION: String = "1.2.0"
    const val LBCUIFIELD_VERSION: String = "1.1.0"
    const val LBCIMAGE_VERSION: String = "1.1.0"
