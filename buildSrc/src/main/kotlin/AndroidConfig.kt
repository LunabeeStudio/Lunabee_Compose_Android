...
object AndroidConfig {
    ...
    const val LBCUIFIELD_CORE_VERSION: String = "1.10.0"
    const val LBCUIFIELD_PHONEPICKER_VERSION: String = "1.4.0"
    const val LBCUIFIELD_COUNTRYPICKER_VERSION: String = "1.3.0"
    const val LBCIMAGE_VERSION: String = "1.6.0"
    const val LBCGLANCE_VERSION: String = "1.5.0"
    const val LBCPRESENTER_VERSION: String = "1.7.0"
