...
object AndroidConfig {
    ...
    const val LBCCORE_VERSION: String = "1.4.0"
    const val LBCFOUNDATION_VERSION: String = "1.3.0"
    const val LBCANDROIDTEST_VERSION: String = "1.3.0"
    const val LBCACCESSIBILITY_VERSION: String = "1.7.0"
    const val LBCTHEME_VERSION: String = "1.3.0"
    const val MATERIAL_COLOR_UTILITIES_VERSION: String = "1.3.0"
