...
### LbcCore, LbcImage, LbcUiField

- Add `lbcImageSpec` to `core`
- New image module with `LbcImage` use to display image data from `lbcImageSpec`
- New uiField module
  - TextField
  - DateField
  - DateTimeField
...
- New module to perform haptics feedback from compose
