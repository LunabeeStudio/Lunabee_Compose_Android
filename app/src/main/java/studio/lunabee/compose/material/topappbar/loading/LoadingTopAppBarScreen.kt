...
package studio.lunabee.compose.material.topappbar.loading
    ...
    Scaffold(
        ...
        Box(
            ...
            LazyColumn(
                ...
                TopAppBarItemFactory.showLoadingTopAppBar(
                    titleRes = R.string.top_bar_screen_simple_description,
                    topAppBarState = topAppBarState,
                    lazyListScope = this,
                )

                TopAppBarItemFactory.showLoadingTopAppBarWithMenu(
